...
export default function ListScreenToolbar({
  ...
  return (
    <div className="no-print list-screen-toolbar border-b border-slate-200 dark:border-slate-800">
          ...
          {filterContent ? (
            <button
              ...
              className={`btn-secondary py-1.5 text-sm ${
                filtersOpen ? 'border-brand-500 text-brand-700 dark:border-brand-400 dark:text-brand-300' : ''
              }`}
